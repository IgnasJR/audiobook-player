  ...
  return (
    <div className="bg-inherit pt-16 w-full flex justify-center">
      ...
      <div className="bg-inherit m-auto h-4/5 shadow-slate-500 border-2 border-slate-700 rounded-lg p-5 bg-slate-700 mt-[5%] sm:ml-32 sm:mr-32 sm:w-1/2">
        ...
        <input
          className="w-full bg-slate-900 text-white rounded-md h-9 text-lg p-2"
          type="text"
          id="album"
        />
        ...
        <input
          className="block w-full text-sm text-white rounded-lg cursor-pointer bg-slate-900"
          multiple
          type="file"
          id="fileInput"
        />
        <button
          className="bg-slate-500 text-slate-100 rounded-lg p-3 font-bold mt-5 pl-6 pr-6"
          disabled={isLoading}
          onClick={UploadFiles}
        >
          Upload
